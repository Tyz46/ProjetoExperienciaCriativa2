<?php
    ...
    if(isset($_GET['id'])){
        ...
        $stmt = $conexao->prepare("UPDATE contratante SET nome = ?, descricao = ?, orcamento = ?, data_publicacao = ? WHERE id = ?"); // prepara a query
        $stmt->bind_param("ssssi",$nome,$descricao,$orcamento,$data_publicacao,$id);
